...
define('THIS_SCRIPT', 'upgrade_400rc4.php');
define('VERSION', '4.0.0 Release Candidate 4');
define('PREV_VERSION', '4.0.0 Release Candidate 3');
...
{
	$upgrade->run_query(
		sprintf($upgrade_phrases['upgrade_300b3.php']['altering_x_table'], 'postparsed', 1, 1),
