...
VALUES
	...
	('tagscategories',   '{$phrasetype['tagscategories']}', 3, 0),
	('advertising',      '{$phrasetype['advertising']}', 3, 0),
	('contenttypes',     '{$phrasetype['contenttypes']}', 3, 0),
	('vbblock',		     '{$phrasetype['vbblock']}', 3, 0),
	('vbblocksettings',  '{$phrasetype['vbblocksettings']}', 3, 0)
";
...
INSERT INTO " . TABLE_PREFIX . "style
	(styleid, title, parentid, templatelist, css, replacements, userselect, displayorder)
VALUES
