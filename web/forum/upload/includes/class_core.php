...
define('FILE_VERSION', '4.0.5'); // this should match installsteps.php
define('SIMPLE_VERSION', '405'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 37685 $
* @date		$Date: 2010-06-24 08:06:50 -0700 (Thu, 24 Jun 2010) $
*/
class vB_Database
{
	/**
	...
	*/
	...
	function resolve_request_url($registry)
	{
		...
		*/
		...
		if ((PHP_SAPI == 'cgi' OR PHP_SAPI == 'cgi-fcgi') AND isset($_SERVER['ORIG_SCRIPT_NAME']))
		{
